	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="<?= base_url() ?>" class="brand-link">
				<!-- <img src="<?= base_url() ?>files/utilities/application-setting/<?= $detail_aplikasi['logo'] ?>" style="width: 15%;" alt="<?= $detail_aplikasi['nama_aplikasi'] ?>" class="brand-image img-circle elevation-3" style="opacity: .8"> -->
				<span style="font-size: 1.15rem!important;" class="brand-text font-weight-light">PT. EDI Indonesia</span>
			</a>
